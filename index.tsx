  ...
  const handleSend = async () => {
    ...
    try {
      if (provider === "nano_banana_pro") {
        ...
        if (provider === "veo") {
          streamingMsgId = `${Date.now()}-veo-streaming`;
